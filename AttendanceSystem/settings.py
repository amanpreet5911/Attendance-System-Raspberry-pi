...
SECRET_KEY = 'django-insecure-gzdv8s((05np0u6zzh1f!-jq_o7_*)%349g+0qfl+k3$)##402'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'libraries':{
            'attendance_tag': 'checkAttendance.templatetags.attendance_extras',
